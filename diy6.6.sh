...
sed -i '2i src-git luci https://github.com/openwrt/luci.git;openwrt-24.10' feeds.conf.default
...
sed -i "/uci commit system/i\uci set system.@system[0].hostname='OpenWrt-King'" package/base-files/files/bin/config_generate
